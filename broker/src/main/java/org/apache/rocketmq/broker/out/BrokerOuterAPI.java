...
public class BrokerOuterAPI {
    ...
    public List<RegisterBrokerResult> registerBrokerAll(
        ...
        if (nameServerAddressList != null && nameServerAddressList.size() > 0) {
            ...
            final RegisterBrokerRequestHeader requestHeader = new RegisterBrokerRequestHeader(); //心跳包请求头
            ...
            for (final String namesrvAddr : nameServerAddressList) { //遍历所有nameServer列表
                brokerOuterExecutor.execute(new Runnable() {
                    ...
                    public void run() {
                        try {
                            RegisterBrokerResult result = registerBroker(namesrvAddr,oneway, timeoutMills,requestHeader,body); //向nameServer注册
                            if (result != null) {
